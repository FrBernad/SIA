...
if __name__ == "__main__":
    ...
    for i in range(len(input_parts)):
        ...
        mean_std_training_values.append(mean(std(training_input, axis=0)))
        ...
        testing_error = perceptron.calculate_error(predicted_testing, testing_output)[0]
        mse_testing.append(testing_error)
        mean_std_testing_values.append(mean(std(testing_input, axis=0)))
